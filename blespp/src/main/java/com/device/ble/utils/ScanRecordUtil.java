...
public class ScanRecordUtil {
    private static final String TAG = ScanRecordUtil.class.getName();
    ...
    public static final int UUID_BYTES_16_BIT = 16;
    public static final int UUID_BYTES_32_BIT = 32;
    public static final int UUID_BYTES_128_BIT = 128;

    /**
     * Parse scan record bytes to {@link ScanRecordUtil}.
     * <p>
...
//            Log.e(TAG, "unable to parse scan record: " + Arrays.toString(scanRecord));
    ...
    public String toString() {
        return "ScanRecord [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
                + ", mManufacturerSpecificData=" + ScanRecordUtil.toString(
